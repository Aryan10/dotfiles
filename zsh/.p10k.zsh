# Generated by Powerlevel10k configuration wizard on 2025-12-05 at 20:56 IST.
...
() {
  ...
  # --- CUSTOM --- #
  # Custom directory truncation rules for Windows drive
  # typeset -g POWERLEVEL9K_DIR_PATH_ABSOLUTE=(
  #   '/run/media/ultra/OS/Users/Shiva' ''
  #   '/run/media/ultra/OS'             ' C:'
  # )

  # typeset -g POWERLEVEL9K_DIR_CLASSES=(
  #   '/run/media/ultra/OS/Users/Shiva(|/*)'   SHIVA_HOME  ''
  #   '/run/media/ultra/OS(|/*)'               WINDOWS     ''
  #   '*'                                      DEFAULT     ''
  # )

  function POWERLEVEL10K_DIR_TRANSFORM() {
  echo "TEST_TRANSFORM"
}


  # typeset -g POWERLEVEL9K_DIR_WINDOWS_OS_FOREGROUND=4

  # Directory display rules for this class
  # typeset -g POWERLEVEL9K_DIR_WINDOWS_FORMAT=' ${P9K_DIR_SHORTENED}'

  # Icon override for SHIVA directory
  # typeset -g POWERLEVEL9K_DIR_SHIVA_HOME_VISUAL_IDENTIFIER_EXPANSION=''
  # typeset -g POWERLEVEL9K_DIR_SHIVA_HOME_PREFIX=''

  # Icon override for WINDOWS root directory
  # typeset -g POWERLEVEL9K_DIR_WINDOWS_VISUAL_IDENTIFIER_EXPANSION=''
